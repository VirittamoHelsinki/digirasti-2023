      ...
      <div className="mainPageFrame">
        <div className="innerPageFrame">
          ...
          <div className="pageContentFrame">
            ...
            <p>
              Valitse teksti maalaamalla eli kuljettamalla hiirtä sen yli vasen painike alas painettuna. Kun koko kopioitavan tekstin tausta on sininen, paina
              hiiren oikeaa näppäintä maalatun tekstin päällä. Valitse lisävalikosta "<strong>Kopioi</strong>". Siirrä kursori (hiiren osoitin) tyhjän laatikon
              päälle ja paina hiiren oikealla painikkeella ja valitse lisävalikosta "<strong>Liitä</strong>".
            </p>
          </div>
        </div>
        <div className="pageContentFrame">
          ...
          <button
            ...
            onClick={() => {
              if (copied.trim() === myArray[0]) {
                setText(<Right text="Tee seuraavaksi alapuolelta löytyvä tehtävä." />);
              } else {
                setText(<Wrong />);
              }
            }}
        ...
        <div className="pageContentFrame">
          ...
          <p>
            Kopioi teksti maalaamalla se ja painamalla näppäimiä <strong>Ctrl + C</strong> samanaikaisesti.
            <br />
            Siirrä kursori (hiiren osoitin) tyhjän laatikon päälle ja liitä teksti laatikkoon klikkaamalla hiirellä ja paina sitten näppäimiä{" "}
        ...
        <div className="pageContentFrame">
          ...
          <textarea
            ...
            name="secondCopied"
            onChange={(e) => setSecondCopied(e.target.value)}
          />
          <br />
          {secondText}
          <button
            ...
            onClick={() => {
              if (secondCopied.toString() === myArray[3]) {
                setSecondText(<Right text="Voit siirtyä seuraavaan tehtävään alla olevasta napista!" />);
              } else {
                setSecondText(<Wrong />);
              }
            }}
        ...
        <Link to="/tietoturva" className="nextPracButton" role="button">
          Seuraava tehtävä
        </Link>
      </div>
    </div>
